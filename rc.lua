...
globalkeys = gears.table.join(
    ...
    -- Rofi
    awful.key({ modkey },            "space",     function () awful.util.spawn("rofi -show drun -theme dmenu") end,
...
-- Autostart
awful.spawn.with_shell("/home/eu/.config/polybar/launch.sh")
awful.spawn.with_shell("nitrogen --set-zoom-fill --head=0 --restore")
awful.spawn.with_shell("nitrogen --set-zoom-fill --head=1 --restore")
